...
<body>
    <div class="sidebargiris">
        <div class="itemGiris">
    <h1 class="titlegiris">Giriş Yap</h1>
    <p class="titlegiris2">Yeni Kullanıcı mısın?<a class="linkGiris" href="kayitol.html"> Bir Hesap Oluşturun</a></p>
        ...
        <form action="" method="POST">
            <div class="girisForm">
                ...
                <div class="formGroup">
                    <button class="btnGiris">Giriş Yap</button>
                </div>
            </div>
        </form>
